      ...
      reader.onload = (e) => {
        ...
        if (arrayBuffer) {
          ...
          jszip.loadAsync(arrayBuffer).then((zip) => {
            ...
            if (zip.files['save.json'] !== undefined && zip.files['traces.json'] !== undefined) {
                ...
                if (relativePath == 'save.json') {
                  file.async('string').then((content) => {
                    ...
                    try {
                      ...
                      console.error(e);
                      this._snackBar.open(this.translate.instant('snackbar_loading_fail'), '', { duration: 5000, panelClass: 'snackbar-fail' });
                    }
